...
func TestWithMCPParse(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			method:         http.MethodPost,
			path:           "/mcp",
			body:           `{"jsonrpc":"2.0","method":"tools/call","params":{"name":"get_file_contents","arguments":{"owner":"github","repo":"omnigit-mcp","path":"README.md"}}}`,
			expectInfo:     true,
			expectedMethod: "tools/call",
			expectedItem:   "get_file_contents",
			expectedOwner:  "github",
			expectedRepo:   "omnigit-mcp",
			expectedArgs:   map[string]any{"owner": "github", "repo": "omnigit-mcp", "path": "README.md"},
		},
		{
		...
		},
		{
			...
			method:         http.MethodPost,
			path:           "/mcp",
			body:           `{"jsonrpc":"2.0","method":"resources/read","params":{"uri":"repo://aifity/omnigit-mcp"}}`,
			expectInfo:     true,
			expectedMethod: "resources/read",
			expectedItem:   "repo://aifity/omnigit-mcp",
		},
		{
