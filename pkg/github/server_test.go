...
// GITHUB_MCP_SERVER_TITLE env vars or omnigit-mcp-config.json) and
...
func TestNewServer_NameAndTitleViaTranslation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			srv := NewServer("v1.0.0", tt.translator("SERVER_NAME", "omnigit-mcp"), tt.translator("SERVER_TITLE", "GitHub MCP Server"), nil)
