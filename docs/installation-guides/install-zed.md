...
- **Docker errors on the local server**: ensure Docker Desktop is running and the `ghcr.io/aifity/omnigit-mcp` image has been pulled at least once. Try `docker pull ghcr.io/aifity/omnigit-mcp` from a terminal.
