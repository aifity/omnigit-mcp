...
[mcp_servers.github]
command = "docker"
args = ["run", "-i", "--rm", "-p", "127.0.0.1:8085:8085", "-e", "GITHUB_OAUTH_CALLBACK_PORT", "ghcr.io/aifity/omnigit-mcp"]
...
- Release binaries: [GitHub Releases](https://github.com/aifity/omnigit-mcp/releases)
