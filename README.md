...
- **pull_request_comment_write** - Update or delete pull request review comment
  - **Required OAuth Scopes**: `repo`
  - `body`: New comment content (required for update method) (string, optional)
  - `comment_id`: Review comment ID to update or delete. Use database_id from get_review_comments. (number, required)
...
|-----|---------------------|---------|
| `SERVER_NAME` | `GITHUB_MCP_SERVER_NAME` | `omnigit-mcp` |
